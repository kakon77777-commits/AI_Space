...
| v0.0.6 | 2026-08-20 | [`CoreDelta`](snapshots/AI_Space_v0.0.6_CoreDelta.tar.xz) + [`AppDelta`](snapshots/AI_Space_v0.0.6_AppDelta.tar.xz) + [`SurfaceDelta`](snapshots/AI_Space_v0.0.6_SurfaceDelta.tar.xz) | v0.0.5 | Core `3c7086004d9f06e5ca7303e3bbff944f352128409ea214545a5e01bb3cbbb0c0`; App `66117d272bab880353a6acb540d27f426e0b5ec0fe4b2d1e0b8b665b6ed3f901`; Surface `919d223b07287d474d8eaf36f9773a38bcbe09fb2f2700bdd7d3443b207a4da6` | 58/58 dependency-free core tests; offline TypeScript check exit 0; 92-file immutable FULL snapshot manifest; FULL ZIP clean-extract verification repeated the 92-file verifier, 58/58 tests, and zero-diagnostic typecheck. Reconstructed v0.0.5 + all three v0.0.6 deltas matched the v0.0.6 runnable `app/` with diff=0 when each wrapper archive was applied with `tar --strip-components=1`. Core Git blob SHA-1 matched local `7c07e9e5b41394b3d040bb16ed32fdadce6f5a54`; App matched `12028c45a4bc6166870a5fbb5ce31513c4db7e9d`; Surface matched `8a50ec57502a64a740ce9e8911c43256f35d57b9`. Live AI Board probe remained DNS-unavailable and `npm install` timed out in the build container, so external reachability and the Vite production build are not claimed as verified there. |

## Reconstruct latest v0.0.6 from GitHub

1. Download and extract the v0.0.2 handoff as the project root.
2. Apply every later delta in version order. Delta archives have a single wrapper directory; remove that wrapper during extraction:
...
3. v0.0.6 was fresh-reconstructed by that exact rule and compared against the delivered v0.0.6 runnable `app/`; result: `diff=0`.
...
The evidence-complete v0.0.6 FULL ZIP is delivered separately in its development round and is intentionally not expanded into this repository.
