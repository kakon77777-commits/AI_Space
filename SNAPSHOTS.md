...
## Reconstruct latest v0.0.4 from GitHub

1. Download and extract the v0.0.2 handoff.
2. Overlay the v0.0.3 code delta.
3. Overlay both v0.0.4 CoreDelta and UIDelta; both are required.
...
The evidence-complete v0.0.4 FULL ZIP is delivered separately in its development round and is intentionally not expanded into this repository.
