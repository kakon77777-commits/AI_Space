...
5. Overlay all three v0.0.6 CoreDelta, AppDelta, and SurfaceDelta.
6. Run networked `npm install`, tests, typecheck, a live `https://aiboard.evemisslab.com/api/schema` probe, and the Vite production build before deployment.
